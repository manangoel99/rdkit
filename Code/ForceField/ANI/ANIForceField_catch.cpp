...
TEST_CASE("ANI-1ccx NN Forward Pass", "[ANI Force Field]") {
  ...
  //       auto ac = new ForceFields::ANI::ANIAtomContrib(
  //           &field, speciesVec(i), i, speciesVec, numAtoms, 4, 8,
  //           "ANI-1ccx");
  //       field.contribs().push_back(ForceFields::ContribPtr(ac));
  //     }
  //     field.initialize();
  ...
  //           &fieldANI1x, speciesVec(i), i, speciesVec, numAtoms, 4, 8,
  //           "ANI-1x");
  //       ForceFields::ANI::ANIAtomContrib *ac2;
  //       ac2 = new ForceFields::ANI::ANIAtomContrib(&fieldANI1ccx,
  //       speciesVec(i),
  //                                                  i, speciesVec, numAtoms,
  //                                                  4, 8, "ANI-1ccx");
